...
function App() {
  ...
  return (
    <>
      <div id={"page"} className={"grid min-h-screen place-items-center"}>
        <div className={"mx-auto grid h-[800px] w-full max-w-screen-sm px-6 pb-20 font-Manrope lg:flex lg:max-w-screen-lg lg:flex-col lg:items-center lg:px-0 lg:pb-0"}>
